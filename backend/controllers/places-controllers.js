...
const updatePlace = async (req, res, next) => {
  ...
  const { title, description, category, city, link, long, id, imgsData,
    ...
    zoom,
    pause,showImageFeaturedInPause,playicon,disTourTitle,pauseOpacity,cssTourTitle,EnableLine,LineTitle,carouselDesing,tourHd,lastEdit } = req.body
